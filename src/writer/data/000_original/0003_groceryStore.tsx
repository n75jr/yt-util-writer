...
const products: Product[] = [
  {
    ...
    family: false,
    quick: true,
    tags: ["Bakery", "Everyday", "Quick"],
    origin: "Texas",
    accent: "linear-gradient(135deg, #22c55e 0%, #10b981 50%, #0f766e 100%)",
    description:
      "Balanced flavor, reliable shelf life, and a clean fit for bakery baskets with strong repeat-purchase behavior.",
  },
  {
    id: "product-2",
    ...
    family: false,
    quick: true,
    tags: ["Dairy", "Everyday", "Quick"],
    origin: "Maine",
    accent: "linear-gradient(135deg, #84cc16 0%, #14b8a6 55%, #2563eb 100%)",
    description:
      "Balanced flavor, reliable shelf life, and a clean fit for dairy baskets with strong repeat-purchase behavior.",
  },
  {
    id: "product-3",
    ...
    family: false,
    quick: false,
    tags: ["Meat", "Organic", "Quick"],
    origin: "Florida",
    accent: "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #7c3aed 100%)",
    description:
      "Balanced flavor, reliable shelf life, and a clean fit for meat baskets with strong repeat-purchase behavior.",
  },
  {
    id: "product-4",
    ...
    family: true,
    quick: true,
    tags: ["Frozen", "Everyday", "Family"],
    origin: "Washington",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    description:
      "Balanced flavor, reliable shelf life, and a clean fit for frozen baskets with strong repeat-purchase behavior.",
  },
  {
    id: "product-5",
    name: "River Pasta 5",
    ...
    family: false,
    quick: true,
    tags: ["Pantry", "Everyday", "Quick"],
    origin: "Vermont",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    description:
      "Balanced flavor, reliable shelf life, and a clean fit for pantry baskets with strong repeat-purchase behavior.",
  },
  {
    id: "product-6",
    ...
    family: false,
    quick: false,
    tags: ["Snacks", "Organic", "Quick"],
    origin: "Georgia",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    description:
      "Balanced flavor, reliable shelf life, and a clean fit for snacks baskets with strong repeat-purchase behavior.",
  },
  {
    id: "product-7",
    name: "Daily Juice 7",
    ...
    family: false,
    quick: true,
    tags: ["Drinks", "Everyday", "Quick"],
    origin: "California",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    description:
      "Balanced flavor, reliable shelf life, and a clean fit for drinks baskets with strong repeat-purchase behavior.",
  },
  {
    id: "product-8",
    name: "Crisp Apples 8",
    ...
    family: true,
    quick: true,
    tags: ["Produce", "Everyday", "Family"],
    origin: "Oregon",
    accent: "linear-gradient(135deg, #f59e0b 0%, #fb7185 45%, #22c55e 100%)",
    description:
      "Balanced flavor, reliable shelf life, and a clean fit for produce baskets with strong repeat-purchase behavior.",
  },
  {
    id: "product-9",
...
const bundles: Bundle[] = [
  {
    ...
    savings: "11%",
    accent: "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #7c3aed 100%)",
    productIds: ["product-1", "product-2", "product-3", "product-4", "product-5", "product-6"],
  },
  {
    id: "bundle-2",
    ...
    savings: "12%",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    productIds: ["product-6", "product-7", "product-8", "product-9", "product-10", "product-11"],
  },
  {
    id: "bundle-3",
    name: "Meat Starter 3",
    ...
    savings: "13%",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    productIds: ["product-11", "product-12", "product-13", "product-14", "product-15", "product-16"],
  },
  {
    id: "bundle-4",
    ...
    savings: "14%",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    productIds: ["product-16", "product-17", "product-18", "product-19", "product-20", "product-21"],
  },
  {
    id: "bundle-5",
    ...
    savings: "15%",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    productIds: ["product-21", "product-22", "product-23", "product-24", "product-25", "product-26"],
  },
  {
    id: "bundle-6",
    ...
    savings: "16%",
    accent: "linear-gradient(135deg, #f59e0b 0%, #fb7185 45%, #22c55e 100%)",
    productIds: ["product-26", "product-27", "product-28", "product-29", "product-30", "product-31"],
  },
  {
    id: "bundle-7",
    ...
    savings: "17%",
    accent: "linear-gradient(135deg, #22c55e 0%, #10b981 50%, #0f766e 100%)",
    productIds: ["product-31", "product-32", "product-33", "product-34", "product-35", "product-36"],
  },
  {
    id: "bundle-8",
    ...
    savings: "18%",
    accent: "linear-gradient(135deg, #84cc16 0%, #14b8a6 55%, #2563eb 100%)",
    productIds: ["product-36", "product-37", "product-38", "product-39", "product-40", "product-41"],
  },
  {
    id: "bundle-9",
    ...
    savings: "19%",
    accent: "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #7c3aed 100%)",
    productIds: ["product-41", "product-42", "product-43", "product-44", "product-45", "product-46"],
  },
  {
    id: "bundle-10",
    ...
    savings: "20%",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    productIds: ["product-46", "product-47", "product-48", "product-49", "product-50", "product-51"],
  },
  {
    id: "bundle-11",
    ...
    savings: "21%",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    productIds: ["product-51", "product-52", "product-53", "product-54", "product-55", "product-56"],
  },
  {
    id: "bundle-12",
    ...
    savings: "22%",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    productIds: ["product-56", "product-57", "product-58", "product-59", "product-60", "product-61"],
  },
  {
    id: "bundle-13",
    ...
    savings: "23%",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    productIds: ["product-61", "product-62", "product-63", "product-64", "product-65", "product-66"],
  },
  {
    id: "bundle-14",
    ...
    savings: "24%",
    accent: "linear-gradient(135deg, #f59e0b 0%, #fb7185 45%, #22c55e 100%)",
    productIds: ["product-66", "product-67", "product-68", "product-69", "product-70", "product-71"],
  },
  {
    id: "bundle-15",
    ...
    savings: "25%",
    accent: "linear-gradient(135deg, #22c55e 0%, #10b981 50%, #0f766e 100%)",
    productIds: ["product-71", "product-72", "product-73", "product-74", "product-75", "product-76"],
  },
  {
    id: "bundle-16",
    ...
    savings: "26%",
    accent: "linear-gradient(135deg, #84cc16 0%, #14b8a6 55%, #2563eb 100%)",
    productIds: ["product-76", "product-77", "product-78", "product-79", "product-80", "product-81"],
  },
  {
    id: "bundle-17",
    ...
    savings: "27%",
    accent: "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #7c3aed 100%)",
    productIds: ["product-81", "product-82", "product-83", "product-84", "product-85", "product-86"],
  },
  {
    id: "bundle-18",
    ...
    savings: "28%",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    productIds: ["product-86", "product-87", "product-88", "product-89", "product-90", "product-91"],
  },
  {
    id: "bundle-19",
    ...
    savings: "29%",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    productIds: ["product-91", "product-92", "product-93", "product-94", "product-95", "product-96"],
  },
  {
    id: "bundle-20",
    ...
    savings: "30%",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    productIds: ["product-96", "product-97", "product-98", "product-99", "product-100", "product-101"],
  },
  {
    id: "bundle-21",
    ...
    savings: "31%",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    productIds: ["product-101", "product-102", "product-103", "product-104", "product-105", "product-106"],
  },
  {
    id: "bundle-22",
    ...
    savings: "32%",
    accent: "linear-gradient(135deg, #f59e0b 0%, #fb7185 45%, #22c55e 100%)",
    productIds: ["product-106", "product-107", "product-108", "product-109", "product-110", "product-111"],
  },
  {
    id: "bundle-23",
    ...
    savings: "33%",
    accent: "linear-gradient(135deg, #22c55e 0%, #10b981 50%, #0f766e 100%)",
    productIds: ["product-111", "product-112", "product-113", "product-114", "product-115", "product-116"],
  },
  {
    id: "bundle-24",
    ...
    savings: "34%",
    accent: "linear-gradient(135deg, #84cc16 0%, #14b8a6 55%, #2563eb 100%)",
    productIds: ["product-116", "product-117", "product-118", "product-119", "product-120", "product-121"],
  },
  {
    id: "bundle-25",
    ...
    savings: "35%",
    accent: "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #7c3aed 100%)",
    productIds: ["product-121", "product-122", "product-123", "product-124", "product-125", "product-126"],
  },
  {
    id: "bundle-26",
    ...
    savings: "36%",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    productIds: ["product-126", "product-127", "product-128", "product-129", "product-130", "product-131"],
  },
  {
    id: "bundle-27",
    ...
    savings: "37%",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    productIds: ["product-131", "product-132", "product-133", "product-134", "product-135", "product-136"],
  },
  {
    id: "bundle-28",
    ...
    savings: "38%",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    productIds: ["product-136", "product-137", "product-138", "product-139", "product-140", "product-141"],
  },
  {
    id: "bundle-29",
    ...
    savings: "39%",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    productIds: ["product-141", "product-142", "product-143", "product-144", "product-145", "product-146"],
  },
  {
    id: "bundle-30",
    ...
    savings: "40%",
    accent: "linear-gradient(135deg, #f59e0b 0%, #fb7185 45%, #22c55e 100%)",
    productIds: ["product-146", "product-147", "product-148", "product-149", "product-150", "product-151"],
  },
  {
    id: "bundle-31",
    ...
    savings: "41%",
    accent: "linear-gradient(135deg, #22c55e 0%, #10b981 50%, #0f766e 100%)",
    productIds: ["product-151", "product-152", "product-153", "product-154", "product-155", "product-156"],
  },
  {
    id: "bundle-32",
    ...
    savings: "42%",
    accent: "linear-gradient(135deg, #84cc16 0%, #14b8a6 55%, #2563eb 100%)",
    productIds: ["product-156", "product-157", "product-158", "product-159", "product-160", "product-161"],
  },
  {
    id: "bundle-33",
    ...
    savings: "43%",
    accent: "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #7c3aed 100%)",
    productIds: ["product-161", "product-162", "product-163", "product-164", "product-165", "product-166"],
  },
  {
    id: "bundle-34",
    ...
    savings: "44%",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    productIds: ["product-166", "product-167", "product-168", "product-169", "product-170", "product-171"],
  },
  {
    id: "bundle-35",
    ...
    savings: "45%",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    productIds: ["product-171", "product-172", "product-173", "product-174", "product-175", "product-176"],
  },
  {
    id: "bundle-36",
    ...
    savings: "46%",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    productIds: ["product-176", "product-177", "product-178", "product-179", "product-180", "product-181"],
  },
  {
    id: "bundle-37",
    ...
    savings: "47%",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    productIds: ["product-181", "product-182", "product-183", "product-184", "product-185", "product-186"],
  },
  {
    id: "bundle-38",
    ...
    savings: "48%",
    accent: "linear-gradient(135deg, #f59e0b 0%, #fb7185 45%, #22c55e 100%)",
    productIds: ["product-186", "product-187", "product-188", "product-189", "product-190", "product-191"],
  },
  {
    id: "bundle-39",
    ...
    savings: "49%",
    accent: "linear-gradient(135deg, #22c55e 0%, #10b981 50%, #0f766e 100%)",
    productIds: ["product-191", "product-192", "product-193", "product-194", "product-195", "product-196"],
  },
  {
    id: "bundle-40",
    ...
    savings: "50%",
    accent: "linear-gradient(135deg, #84cc16 0%, #14b8a6 55%, #2563eb 100%)",
    productIds: ["product-196", "product-197", "product-198", "product-199", "product-200", "product-201"],
  },
];
...
const recipes: Recipe[] = [
  {
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    ingredientIds: ["product-1", "product-2", "product-3", "product-4", "product-5"],
  },
  {
    id: "recipe-2",
    ...
    difficulty: "Quick",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    ingredientIds: ["product-8", "product-9", "product-10", "product-11", "product-12"],
  },
  {
    id: "recipe-3",
    title: "Golden Bowl 3",
    ...
    difficulty: "Easy",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    ingredientIds: ["product-15", "product-16", "product-17", "product-18", "product-19"],
  },
  {
    id: "recipe-4",
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    ingredientIds: ["product-22", "product-23", "product-24", "product-25", "product-26"],
  },
  {
    id: "recipe-5",
    title: "River Bowl 5",
    ...
    difficulty: "Quick",
    accent: "linear-gradient(135deg, #f59e0b 0%, #fb7185 45%, #22c55e 100%)",
    ingredientIds: ["product-29", "product-30", "product-31", "product-32", "product-33"],
  },
  {
    id: "recipe-6",
    title: "Fresh Bowl 6",
    ...
    difficulty: "Easy",
    accent: "linear-gradient(135deg, #22c55e 0%, #10b981 50%, #0f766e 100%)",
    ingredientIds: ["product-36", "product-37", "product-38", "product-39", "product-40"],
  },
  {
    id: "recipe-7",
    title: "Daily Bowl 7",
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #84cc16 0%, #14b8a6 55%, #2563eb 100%)",
    ingredientIds: ["product-43", "product-44", "product-45", "product-46", "product-47"],
  },
  {
    id: "recipe-8",
    title: "Crisp Bowl 8",
    ...
    difficulty: "Quick",
    accent: "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #7c3aed 100%)",
    ingredientIds: ["product-50", "product-51", "product-52", "product-53", "product-54"],
  },
  {
    id: "recipe-9",
    title: "Velvet Bowl 9",
    ...
    difficulty: "Easy",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    ingredientIds: ["product-57", "product-58", "product-59", "product-60", "product-61"],
  },
  {
    id: "recipe-10",
    title: "Sunny Bowl 10",
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    ingredientIds: ["product-64", "product-65", "product-66", "product-67", "product-68"],
  },
  {
    id: "recipe-11",
    title: "Farm Bowl 11",
    ...
    difficulty: "Quick",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    ingredientIds: ["product-71", "product-72", "product-73", "product-74", "product-75"],
  },
  {
    id: "recipe-12",
    ...
    difficulty: "Easy",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    ingredientIds: ["product-78", "product-79", "product-80", "product-81", "product-82"],
  },
  {
    id: "recipe-13",
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #f59e0b 0%, #fb7185 45%, #22c55e 100%)",
    ingredientIds: ["product-85", "product-86", "product-87", "product-88", "product-89"],
  },
  {
    id: "recipe-14",
    ...
    difficulty: "Quick",
    accent: "linear-gradient(135deg, #22c55e 0%, #10b981 50%, #0f766e 100%)",
    ingredientIds: ["product-92", "product-93", "product-94", "product-95", "product-96"],
  },
  {
    id: "recipe-15",
    title: "River Bowl 15",
    ...
    difficulty: "Easy",
    accent: "linear-gradient(135deg, #84cc16 0%, #14b8a6 55%, #2563eb 100%)",
    ingredientIds: ["product-99", "product-100", "product-101", "product-102", "product-103"],
  },
  {
    id: "recipe-16",
    title: "Fresh Bowl 16",
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #7c3aed 100%)",
    ingredientIds: ["product-106", "product-107", "product-108", "product-109", "product-110"],
  },
  {
    id: "recipe-17",
    title: "Daily Bowl 17",
    ...
    difficulty: "Quick",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    ingredientIds: ["product-113", "product-114", "product-115", "product-116", "product-117"],
  },
  {
    id: "recipe-18",
    title: "Crisp Bowl 18",
    ...
    difficulty: "Easy",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    ingredientIds: ["product-120", "product-121", "product-122", "product-123", "product-124"],
  },
  {
    id: "recipe-19",
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    ingredientIds: ["product-127", "product-128", "product-129", "product-130", "product-131"],
  },
  {
    id: "recipe-20",
    title: "Sunny Bowl 20",
    ...
    difficulty: "Quick",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    ingredientIds: ["product-134", "product-135", "product-136", "product-137", "product-138"],
  },
  {
    id: "recipe-21",
    title: "Farm Bowl 21",
    ...
    difficulty: "Easy",
    accent: "linear-gradient(135deg, #f59e0b 0%, #fb7185 45%, #22c55e 100%)",
    ingredientIds: ["product-141", "product-142", "product-143", "product-144", "product-145"],
  },
  {
    id: "recipe-22",
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #22c55e 0%, #10b981 50%, #0f766e 100%)",
    ingredientIds: ["product-148", "product-149", "product-150", "product-151", "product-152"],
  },
  {
    id: "recipe-23",
    ...
    difficulty: "Quick",
    accent: "linear-gradient(135deg, #84cc16 0%, #14b8a6 55%, #2563eb 100%)",
    ingredientIds: ["product-155", "product-156", "product-157", "product-158", "product-159"],
  },
  {
    id: "recipe-24",
    ...
    difficulty: "Easy",
    accent: "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #7c3aed 100%)",
    ingredientIds: ["product-162", "product-163", "product-164", "product-165", "product-166"],
  },
  {
    id: "recipe-25",
    title: "River Bowl 25",
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #38bdf8 0%, #6366f1 45%, #f472b6 100%)",
    ingredientIds: ["product-169", "product-170", "product-171", "product-172", "product-173"],
  },
  {
    id: "recipe-26",
    title: "Fresh Bowl 26",
    ...
    difficulty: "Quick",
    accent: "linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #f59e0b 100%)",
    ingredientIds: ["product-176", "product-177", "product-178", "product-179", "product-180"],
  },
  {
    id: "recipe-27",
    title: "Daily Bowl 27",
    ...
    difficulty: "Easy",
    accent: "linear-gradient(135deg, #4ade80 0%, #22c55e 55%, #16a34a 100%)",
    ingredientIds: ["product-183", "product-184", "product-185", "product-186", "product-187"],
  },
  {
    id: "recipe-28",
    title: "Crisp Bowl 28",
    ...
    difficulty: "Medium",
    accent: "linear-gradient(135deg, #facc15 0%, #fb7185 50%, #60a5fa 100%)",
    ingredientIds: ["product-190", "product-191", "product-192", "product-193", "product-194"],
  },
];
...
function App() {
  ...
  const [favorite, setFavorite] = useState<Record<string, boolean>>(() =>
    Object.fromEntries(products.map((product) => [product.id, product.weekly && product.organic])),
  );
  ...
  const visibleProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      ...
      const matchesSearch =
        term.length === 0 ||
        `${product.name} ${product.subtitle} ${product.brand} ${product.origin}`.toLowerCase().includes(term);
      return matchesCategory && matchesFilter && matchesSearch;
    });
  }, [activeCategory, activeFilter, deferredSearch]);

  const featuredBundle = useMemo(
    () => bundles.find((bundle) => bundle.id === featuredBundleId) ?? bundles[0],
    [featuredBundleId],
  );
  ...
  const totals = useMemo(() => {
    ...
    const savings = cartItems.reduce(
      (sum, item) => sum + (item.product.weekly ? item.product.price * item.qty * 0.08 : 0),
      0,
    );
      ...
      <div className="grocery-shell">
        <aside className="sidebar">
          ...
          <section className="sidebar-card">
            ...
            <div className="metric-stack">
              ...
              <div>
                <strong>{currency.format(totals.savings)}</strong>
                <span>active savings</span>
              </div>
              <div>
                <strong>{currency.format(totals.total)}</strong>
                <span>projected checkout</span>
              </div>
            </div>
          </section>
          <section className="sidebar-card">
        ...
        <main className="content">
          <header className="topbar">
            ...
            <label className="searchbox" htmlFor={searchId}>
              ...
              <input
                ...
                placeholder="Produce, dairy, pantry, brand, origin"
                type="search"
                value={search}
              />
            </label>
          ...
          <section
            ...
            style={{
              backgroundImage:
                `${heroProduct.accent}, radial-gradient(circle at top left, rgba(255,255,255,0.26), transparent 40%)`,
            }}
          >
            <div className="hero-copy">
              ...
              <div className="hero-meta">
                ...
                <span>
                  {currency.format(heroProduct.price)} {heroProduct.unit}
                </span>
                <span>{heroProduct.rating} rating</span>
              </div>
              <div className="hero-actions">
                <button className="primary-action" onClick={() => addToCart(heroProduct.id)} type="button">
                  Add to cart
                </button>
                <button className="secondary-action" onClick={() => toggleFavorite(heroProduct.id)} type="button">
                  {favorite[heroProduct.id] ? "Saved" : "Save item"}
                </button>
              </div>
            </div>
            <div className="hero-grid">
              {deliverySlots.map((slot) => (
                <button
                  key={slot.id}
                  className={slot.id === activeSlot ? "page-card active" : "page-card"}
          ...
          <section className="filter-row">
            <div className="chip-row">
              {categoryTabs.map((tab) => (
                <button
                  key={tab.id}
                  className={tab.id === activeCategory ? "chip active" : "chip"}
            ...
            <div className="chip-row subdued">
              {filterTabs.map((tab) => (
                <button
                  key={tab.id}
                  className={tab.id === activeFilter ? "chip compact active" : "chip compact"}
          ...
          <div className="content-grid">
            <section className="panel bundle-panel">
              <div className="section-head">
                <div>
                  ...
                  <h3>Basket builders and promo packs</h3>
                </div>
              ...
              <div className="bundle-grid">
                {bundles
                  ...
                  .map((bundle) => (
                    <button
                      key={bundle.id}
                      className={bundle.id === featuredBundleId ? "bundle-card active" : "bundle-card"}
                      onClick={() => setFeaturedBundleId(bundle.id)}
                      style={{
                        backgroundImage:
                          `${bundle.accent}, linear-gradient(180deg, rgba(15,23,42,0.3), rgba(15,23,42,0.94))`,
                      }}
                      type="button"
                    >
            ...
            <section className="panel catalog-panel">
              <div className="section-head">
                <div>
                  ...
                  <h3>{categoryLabels[activeCategory]} picks for this run</h3>
                </div>
                ...
                {visibleProducts.slice(0, 14).map((product) => (
                  <article key={product.id} className="product-row">
                    ...
                    <div className="row-actions">
                      <button
                        className={favorite[product.id] ? "like-button active" : "like-button"}
                        onClick={() => toggleFavorite(product.id)}
                        type="button"
                      >
                        {favorite[product.id] ? "Saved" : "Save"}
                      </button>
                      <button className="primary-action compact" onClick={() => addToCart(product.id)} type="button">
                        Add
                      </button>
                    </div>
                  </article>
                ...
                <article className="insight-card">
                  ...
                  <div className="artist-stack">
                    {categorySpend.map(([category, spend]) => (
                      <div key={category} className="artist-row">
                        <span>{categoryLabels[category as CategoryId]}</span>
                        <b>{currency.format(spend)}</b>
                      </div>
                    ))}
                  </div>
                </article>
            ...
            <section className="panel cart-panel">
                ...
                {cartItems.map(({ product, qty }) => (
                  <article key={product.id} className="cart-row">
                    ...
                    <div className="stepper">
                      <button className="ghost-button" onClick={() => updateCart(product.id, -1)} type="button">
                        -
                      </button>
                      <span>{qty}</span>
                      <button className="ghost-button" onClick={() => updateCart(product.id, 1)} type="button">
              ...
              <div className="checkout-summary">
                <div>
                  <span>Subtotal</span>
                  <b>{currency.format(totals.subtotal)}</b>
                </div>
                <div>
                  <span>Savings</span>
                  <b>-{currency.format(totals.savings)}</b>
                </div>
                <div>
                  <span>Delivery</span>
                  <b>{currency.format(totals.deliveryFee)}</b>
                </div>
                <div className="summary-total">
                  <span>Total</span>
                  <b>{currency.format(totals.total)}</b>
                </div>
              </div>
            </section>
                ...
                <div>
                  <div className="section-head compact">
                    <div>
                      ...
                      <h3>Use what is already in the basket</h3>
                    </div>
                  </div>
                  <div className="recipe-list">
                    {recipes.slice(0, 5).map((recipe) => (
                      <article key={recipe.id} className="recipe-card">
                        <div className="mini-cover" style={{ backgroundImage: recipe.accent }}>
                          {recipe.time}
                        </div>
                        <div>
                ...
                <div>
                  <div className="section-head compact">
                    <div>
                      ...
                      <h3>Delivery and savings plan</h3>
                    </div>
                  </div>
                  <div className="membership-card">
                    <strong>Green Cart+</strong>
                    <p>
                      Free delivery over $35, member-only produce drops, rotating bakery promos, and priority weekend
                      windows.
                    </p>
                    <div className="membership-metrics">
                      ...
                      <div>
                        <b>2x</b>
                        <span>faster checkout repeats</span>
                      </div>
                      <div>
                        <b>12</b>
                        <span>exclusive drops this month</span>
                      </div>
                    </div>
        ...
        <aside className="summary-rail">
          <div className="summary-card spotlight" style={{ backgroundImage: heroProduct.accent }}>
            ...
            <h3>{heroProduct.name}</h3>
            <p>
              {heroProduct.origin} · {heroProduct.brand}
            </p>
          </div>
          <div className="summary-card">
            ...
            <div className="metric-stack">
              <div>
                <strong>{visibleProducts.filter((product) => product.stock > 20).length}</strong>
                <span>healthy stock products</span>
              </div>
              <div>
                <strong>{visibleProducts.filter((product) => product.organic).length}</strong>
                <span>organic options</span>
              </div>
              <div>
                <strong>{visibleProducts.filter((product) => product.weekly).length}</strong>
                <span>weekly deal lines</span>
              </div>
            </div>
          </div>
          <div className="summary-card">
...
body {
  ...
  background:
    ...
    radial-gradient(circle at right 20%, rgba(34, 197, 94, 0.14), transparent 22%),
...
.filter-row
{
  ...
  box-shadow: 0 20px 50px rgba(20, 40, 29, 0.08);
}
...
{
  display: grid;
  grid-template-columns: 16px minmax(0, 1.2fr) minmax(0, 0.9fr) 120px 120px 140px;
  gap: 12px;
  align-items: center;
  border-radius: 20px;
  padding: 12px;
